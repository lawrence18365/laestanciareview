...
export function buildProspectWhatsappMessage(p: ProspectWhatsappInput): string {
  if (p.tier === 'group') {
    ...
    return (
      ...
      hook +
      ' Le hago una pregunta que casi ningún dueño puede contestar: ¿cuál de sus sucursales recibió menos reseñas de lo normal y cuál de sus meseros tuvo una caída anormal esta semana? Nosotros lo vemos mesero por mesero, turno por turno y sucursal por sucursal. ¿Le enseño cómo en 15 minutos? Sin compromiso.'
    );
  }
  const hook =
  ...
  return (
    'Hola, buen día. Le escribo de parte de RateTap, el sistema con el que La Estancia mide a sus meseros en 12 restaurantes.' +
    hook +
    ' Le hago una pregunta que casi ningún dueño puede contestar: ¿sabe cuál de sus meseros atiende mejor y cuál tuvo una caída anormal en respuestas esta semana? Nosotros lo vemos mesero por mesero y por turno. ¿Le enseño cómo en 10 minutos? Sin compromiso.'
  );
}
