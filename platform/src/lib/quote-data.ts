...
// Prices transcribed from the official June 2026 La Estancia Argentina menu.
// The published menu states that every listed price includes IVA. Event-only
// items that do not appear in that menu (for example, desserts) retain their
// separately managed RateTap prices below.
export const MENU: QuoteDish[] = [
  // Entradas
  { id: 'e1', categoria: 'Entradas', nombre: 'Empanadas', peso: '60g c/u', precio: 120, desc: 'Carne, queso, humita, salmón, siciliana, espinaca, queso azul o chistorra', variants: ['Carne', 'Queso', 'Humita', 'Salmón', 'Siciliana', 'Espinaca', 'Queso azul', 'Chistorra'] },
  { id: 'e2', categoria: 'Entradas', nombre: 'Queso Fundido', peso: '220g', precio: 170 },
  { id: 'e3', categoria: 'Entradas', nombre: 'Queso Fundido con Chistorra', peso: '100g', precio: 190 },
  { id: 'e4', categoria: 'Entradas', nombre: 'Queso Fundido con Chorizo Argentino', peso: '75g', precio: 190 },
  { id: 'e5', categoria: 'Entradas', nombre: 'Camarones con Champiñones al Ajillo', peso: '180g', precio: 420 },
  { id: 'e6', categoria: 'Entradas', nombre: 'Chorizo Argentino', peso: '160g', precio: 165 },
  { id: 'e7', categoria: 'Entradas', nombre: 'Chistorra', peso: '200g', precio: 190 },
  { id: 'e8', categoria: 'Entradas', nombre: 'Chicharrón Rib-Eye', peso: '220g', precio: 395, desc: 'Acompañado de guacamole y pico de gallo' },
  { id: 'e9', categoria: 'Entradas', nombre: 'Mollejas de Ternera', peso: '350g', precio: 298 },
  { id: 'e10', categoria: 'Entradas', nombre: 'Queso Provoleta', peso: '160g', precio: 190 },
  { id: 'e11', categoria: 'Entradas', nombre: 'Provoleta Estancia', peso: '160g', precio: 210 },
  { id: 'e12', categoria: 'Entradas', nombre: 'Carpaccio de Salmón Ahumado', peso: '150g', precio: 298 },
  { id: 'e13', categoria: 'Entradas', nombre: 'Tártara de Atún', peso: '150g', precio: 265 },
  { id: 'e14', categoria: 'Entradas', nombre: 'Burrata Rústica', peso: '130g', precio: 350 },
  { id: 'e15', categoria: 'Entradas', nombre: 'Tiradito de Camarón y Pulpo', peso: '200g', precio: 310 },
  ...
  // Sopas
  { id: 's1', categoria: 'Sopas', nombre: 'Jugo de Carne', peso: '240ml', precio: 180 },
  { id: 's2', categoria: 'Sopas', nombre: 'Jugo de Carne con Ostión', peso: '240ml/50g', precio: 190 },
  { id: 's3', categoria: 'Sopas', nombre: 'Jugo de Carne con Camarón', peso: '240ml/60g', precio: 230 },
  { id: 's4', categoria: 'Sopas', nombre: 'Sopa Estancia', peso: '240ml', precio: 135 },
  { id: 's5', categoria: 'Sopas', nombre: 'Sopa de Cebolla', peso: '240ml', precio: 155 },
  { id: 's6', categoria: 'Sopas', nombre: 'Crema de Tomate Rostizado', peso: '240ml', precio: 165 },
  { id: 's7', categoria: 'Sopas', nombre: 'Crema de Alcachofa', peso: '240ml', precio: 165 },
  { id: 's8', categoria: 'Sopas', nombre: 'Crema de Papa con Jamón Ibérico', peso: '240ml', precio: 180, desc: 'Especial para eventos' },

  // Ensaladas
  { id: 'en1', categoria: 'Ensaladas', nombre: 'Mixta', precio: 140 },
  { id: 'en2', categoria: 'Ensaladas', nombre: 'Santelmo', precio: 195 },
  { id: 'en3', categoria: 'Ensaladas', nombre: 'Falsa Nicoise', precio: 195 },
  { id: 'en4', categoria: 'Ensaladas', nombre: 'Capresse', precio: 195 },
  { id: 'en5', categoria: 'Ensaladas', nombre: 'César', precio: 195, desc: 'Preparada en su mesa' },
  { id: 'en6', categoria: 'Ensaladas', nombre: 'Griega', precio: 195 },
  { id: 'en7', categoria: 'Ensaladas', nombre: 'Evita', precio: 195 },
  { id: 'en8', categoria: 'Ensaladas', nombre: 'Gaucha', precio: 195 },
  { id: 'en9', categoria: 'Ensaladas', nombre: 'Nordika', precio: 295 },
  ...
  // Parrilla
  { id: 'pa1', categoria: 'Parrilla', nombre: 'Bife de Chorizo Pibe', peso: '300g', precio: 685 },
  { id: 'pa2', categoria: 'Parrilla', nombre: 'Bife de Chorizo', peso: '500g', precio: 1120 },
  { id: 'pa3', categoria: 'Parrilla', nombre: 'Bife de Chorizo', peso: '750g', precio: 1670 },
  { id: 'pa4', categoria: 'Parrilla', nombre: 'Rib-Eye Roll', peso: '400g', precio: 1120 },
  { id: 'pa5', categoria: 'Parrilla', nombre: 'Rib-Eye Roll', peso: '600g', precio: 1670 },
  { id: 'pa6', categoria: 'Parrilla', nombre: 'Ojo de Rib-Eye', peso: '300g', precio: 795 },
  { id: 'pa7', categoria: 'Parrilla', nombre: 'Ojo de Rib-Eye', peso: '500g', precio: 1325 },
  { id: 'pa8', categoria: 'Parrilla', nombre: 'Tapa de Rib-Eye', peso: '300g', precio: 795 },
  { id: 'pa9', categoria: 'Parrilla', nombre: 'Tapa de Rib-Eye', peso: '500g', precio: 1325 },
  { id: 'pa10', categoria: 'Parrilla', nombre: 'Cowboy', peso: '500g', precio: 1220 },
  { id: 'pa11', categoria: 'Parrilla', nombre: 'Tomahawk', peso: '1kg', precio: 2250, tag: 'Premium' },
  { id: 'pa12', categoria: 'Parrilla', nombre: 'NY Ribeteado Pibe', peso: '300g', precio: 620 },
  { id: 'pa13', categoria: 'Parrilla', nombre: 'NY Ribeteado', peso: '500g', precio: 990 },
  { id: 'pa14', categoria: 'Parrilla', nombre: 'Bife de Lomo Pibe', peso: '300g', precio: 485 },
  { id: 'pa15', categoria: 'Parrilla', nombre: 'Bife de Lomo', peso: '600g', precio: 795 },
  { id: 'pa16', categoria: 'Parrilla', nombre: 'Medallones de Filete', peso: '300g', precio: 498 },
  { id: 'pa17', categoria: 'Parrilla', nombre: 'Filete Estancia Argentina', peso: '300g', precio: 485 },
  { id: 'pa18', categoria: 'Parrilla', nombre: 'Cabrería', peso: '300g', precio: 550 },
  { id: 'pa19', categoria: 'Parrilla', nombre: 'Arrachera Pibe', peso: '250g', precio: 450 },
  { id: 'pa20', categoria: 'Parrilla', nombre: 'Arrachera', peso: '400g', precio: 610 },
  { id: 'pa21', categoria: 'Parrilla', nombre: 'Tapa de Vacío', peso: '300g', precio: 520 },
  { id: 'pa22', categoria: 'Parrilla', nombre: 'Churrasco Pibe', peso: '400g', precio: 475 },
  { id: 'pa23', categoria: 'Parrilla', nombre: 'Picaña', peso: '300g', precio: 450 },
  { id: 'pa24', categoria: 'Parrilla', nombre: 'Asado de Tira', peso: '500g', precio: 925 },
  { id: 'pa25', categoria: 'Parrilla', nombre: 'Asado de Tira Ancho', peso: '800g', precio: 1360, desc: 'Para 2 personas' },
  { id: 'pa26', categoria: 'Parrilla', nombre: 'Pechuga a las Brasas', peso: '500g', precio: 375 },
  { id: 'pa27', categoria: 'Parrilla', nombre: 'New York Añejo Dry Age', peso: '300g', precio: 950, tag: 'Dry Age' },
  { id: 'pa28', categoria: 'Parrilla', nombre: 'New York Añejo Dry Age', peso: '600g', precio: 1780, tag: 'Dry Age' },
  { id: 'pa29', categoria: 'Parrilla', nombre: 'Rib-Eye Añejo Dry Age', peso: '300g', precio: 950, tag: 'Dry Age' },
  { id: 'pa30', categoria: 'Parrilla', nombre: 'Rib-Eye Añejo Dry Age', peso: '600g', precio: 1780, tag: 'Dry Age' },
  { id: 'pa31', categoria: 'Parrilla', nombre: 'Rib Eye Akaushi', peso: '300g', precio: 1430, tag: 'Akaushi' },
  { id: 'pa32', categoria: 'Parrilla', nombre: 'Rib Eye Akaushi', peso: '500g', precio: 2390, tag: 'Akaushi' },
