/**
 * Apply migration 0005_security_hardening.sql.
 *
 ...
 *
 * Usage:
 *   npx tsx scripts/apply-0005-migration.ts                   # dev
 *   ENV_FILE=.env.production.local npx tsx scripts/apply-0005-migration.ts
 */
...
async function main() {
  ...
  const sql = fs.readFileSync(
    'src/db/migrations/0005_security_hardening.sql',
    'utf8',
  );
