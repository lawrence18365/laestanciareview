 ...
 * via Resend with their audit URL.
 *
 * Usage:
...
const FROM = 'RateTap <hola@ratetapmx.com>';
...
<div style="max-width:560px;margin:32px auto;background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08)">
  ...
  <div style="padding:32px">
    ...
    <p style="margin:0 0 8px;color:#374151;font-size:15px">La prueba es gratis por 15 días.</p>
